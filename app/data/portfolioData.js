...
export const experience = [
  {
    role: 'Research Intern – Quantum Computing Algorithms & Networks',
    company: 'Mecon Limited, Ranchi',
    period: 'June 2024 - July 2024',
    description: 'Internship in the IT Services section with a focus on studying quantum computing algorithms, core and quantum physics concepts. Conducted research and compiled insights into a detailed internship report.',
    highlights: [
      'Studied quantum algorithms and their applications in secure communication',
      'Studied core quantum physics concepts such as qubits, superposition, and entanglement',
      'Prepared and submitted a comprehensive internship report documenting research findings'
    ]
  },
  {
    ...
    description: 'Worked on developing 3D visual experiences using Three.js & GLSL and contributed to backend development of Vidtube, a video hosting platform.',
    highlights: [
